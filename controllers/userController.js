...
const seedUsers = async (req,res) => {
  ...
  try {
    const userSeeds = await User.bulkCreate([{name: "Henry Weigand", email: "henryweigand10@gmail.com", password: req.body.password}, {name: "Loran Scruggs", email: "loranscruggs8@gmail.com", password: req.body.password}], {individualHooks: true});
